...
-- AddForeignKey
ALTER TABLE `UserExamPreferences` ADD CONSTRAINT `UserExamPreferences_examNoteId_fkey` FOREIGN KEY (`examNoteId`) REFERENCES `ExamNote`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
